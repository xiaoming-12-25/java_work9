...
<div class="main">
    <div class="login">
        <div class="log-con">
            ...
            <p class="p2">${sessionScope.errname}</p>
            <input type="text" class="code" name="code" placeholder="请输入验证码">
            <img src="../imgs.do" id="img">
            <p class="p3">${sessionScope.err}</p>
            <input id="a1" type="submit" value="登录">
            <a class="a2" href="register.jsp">注册</a>
            <p class="p1"><a href="#">忘记密码</a></p>
